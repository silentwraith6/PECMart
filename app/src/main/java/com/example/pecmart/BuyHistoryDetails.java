...
public class BuyHistoryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_history_details);
        ...
        showProgress(true);
        tvLoad.setText("Getting seller details...please wait...");
        ...
        String whereclause = "objectId1 = '"+ApplicationClass.completeds.get(index).getSellerId()+"'";
        ...
        Backendless.Persistence.of(user.class).find(queryBuilder, new AsyncCallback<List<user>>() {
            ...
            public void handleResponse(List<user> response) {
                tvbuyername.setText("Seller Name : "+response.get(0).getName());
                tvbuyerphone.setText("Seller Phone : "+response.get(0).getPhone());
                tvbuyerbranch.setText("Seller Branch : "+response.get(0).getBranch());
                tvbuyeremail.setText("Seller Email : "+response.get(0).getEmailID());
                showProgress(false);
            }
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                showProgress(false);
                Toast.makeText(BuyHistoryDetails.this, "Error! "+fault.getMessage(), Toast.LENGTH_SHORT).show();
